...
- (instancetype)initWithDictionary:(NSDictionary *)dict {
    ...
    if (self && [dict isKindOfClass:[NSDictionary class]]) {
        self.createdAt = [self objectOrNilForKey:kPTLabelCreatedAt fromDictionary:dict];
        self.labelIdentifier = [[self objectOrNilForKey:kPTLabelId fromDictionary:dict] doubleValue];
        self.kind = [self objectOrNilForKey:kPTLabelKind fromDictionary:dict];
        self.updatedAt = [self objectOrNilForKey:kPTLabelUpdatedAt fromDictionary:dict];
        self.name = [self objectOrNilForKey:kPTLabelName fromDictionary:dict];
        self.projectId = [[self objectOrNilForKey:kPTLabelProjectId fromDictionary:dict] doubleValue];
    }
...
- (NSDictionary *)dictionaryRepresentation {
    ...
    [mutableDict setValue:[NSNumber numberWithDouble:self.labelIdentifier] forKey:kPTLabelId];
    ...
    [mutableDict setValue:[NSNumber numberWithDouble:self.projectId] forKey:kPTLabelProjectId];
