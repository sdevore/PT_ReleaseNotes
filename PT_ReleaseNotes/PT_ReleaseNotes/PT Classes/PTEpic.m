...
- (instancetype)initWithDictionary:(NSDictionary *)dict
{
    ...
    if(self && [dict isKindOfClass:[NSDictionary class]]) {
        self.updatedAt = [self objectOrNilForKey:kPTEpicUpdatedAt fromDictionary:dict];
        self.url = [self objectOrNilForKey:kPTEpicUrl fromDictionary:dict];
        self.internalBaseClassIdentifier = [[self objectOrNilForKey:kPTEpicId fromDictionary:dict] doubleValue];
        self.createdAt = [self objectOrNilForKey:kPTEpicCreatedAt fromDictionary:dict];
        self.label = [PTLabel modelObjectWithDictionary:[dict objectForKey:kPTEpicLabel]];
        self.kind = [self objectOrNilForKey:kPTEpicKind fromDictionary:dict];
        self.internalBaseClassDescription = [self objectOrNilForKey:kPTEpicDescription fromDictionary:dict];
        self.name = [self objectOrNilForKey:kPTEpicName fromDictionary:dict];
        self.projectId = [[self objectOrNilForKey:kPTEpicProjectId fromDictionary:dict] doubleValue];
...
- (NSDictionary *)dictionaryRepresentation
{
    ...
    [mutableDict setValue:[NSNumber numberWithDouble:self.internalBaseClassIdentifier] forKey:kPTEpicId];
    [mutableDict setValue:self.createdAt forKey:kPTEpicCreatedAt];
    [mutableDict setValue:[self.label dictionaryRepresentation] forKey:kPTEpicLabel];
    [mutableDict setValue:self.kind forKey:kPTEpicKind];
    [mutableDict setValue:self.internalBaseClassDescription forKey:kPTEpicDescription];
    [mutableDict setValue:self.name forKey:kPTEpicName];
    [mutableDict setValue:[NSNumber numberWithDouble:self.projectId] forKey:kPTEpicProjectId];
...
- (id)initWithCoder:(NSCoder *)aDecoder
{
    ...
    self.internalBaseClassDescription = [aDecoder decodeObjectForKey:kPTEpicDescription];
